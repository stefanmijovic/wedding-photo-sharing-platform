...
The repository retains generic screenshots already tracked in `docs/img/`. Review and replace them with assets you have permission to publish before branding a public deployment.

![Landing page](docs/img/landing-page.png)

Additional screenshots: [mobile home](docs/img/mobile-home.png), [upload](docs/img/upload.png), [gallery](docs/img/gallery.png), and [admin dashboard](docs/img/admin-dashboard.png).
